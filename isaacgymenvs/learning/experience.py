...
class CostVectorizedReplayBuffer:
    def __init__(self, obs_shape, action_shape, capacity, device):
        ...
        self.costs = torch.empty((capacity, 1), dtype=torch.float32, device=self.device)
    ...
    def add(self, obs, action, reward, cost, next_obs, done):
        ...
        if remaining_capacity < num_observations:
            ...
            self.costs[0: overflow] = cost[-overflow:]
        ...
        self.costs[self.idx: self.idx + remaining_capacity] = cost[:remaining_capacity]
    ...
    def sample(self, batch_size):
        ...
        return obses, actions, rewards, costs, next_obses, dones
