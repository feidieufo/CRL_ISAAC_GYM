...
class PPOLagBuilder(NetworkBuilder):
    ...
    class Network(NetworkBuilder.BaseNetwork):
        def __init__(self, params, **kwargs):
            ...
            if self.separate:
                ...
                self.cost_mlp = self._build_mlp(**mlp_args)
        ...
        def forward(self, obs_dict):
            ...
            if self.separate:
                ...
                costv = self.costv_act(self.costv(c_out))
                ...
                costv = self.costv_act(self.costv(out))
                ...
                if self.is_continuous:
                    ...
                    return mu, mu*0 + sigma, value, costv, states
    ...
    def build(self, name, **kwargs):
        net = PPOLagBuilder.Network(self.params, **kwargs)
        return net